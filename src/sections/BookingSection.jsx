...
export default function BookingSection() {
    ...
    return (
        <section id="agendar" className="py-20 sm:py-32 bg-background">
            <div className="container mx-auto px-4 sm:px-6 md:px-8">
                ...
                <form className="max-w-4xl mx-auto bg-background-alt/50 p-6 sm:p-8 rounded-2xl shadow-sm">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
                        ...
                        <div className="space-y-8">
                            ...
                            <div>
                                ...
                                <div className="bg-background rounded-lg p-4 shadow-inner flex justify-center">
                                    ...
                                    {availableTimes.map(time => (
                                        <button
                                            ...
                                            className={`px-4 py-3 rounded-lg font-semibold border-2 transition ${selectedTime === time
                                                ...
                                                : 'bg-background text-text-primary border-transparent hover:border-accent hover:text-accent'
                                                }`}
                                        >
                                            {time}
                                        </button>
                        ...
                        <div className="space-y-6 flex flex-col">
                            ...
                            <div>
                                ...
                                <input type="text" id="name" name="name" placeholder="John Doe" className="block w-full px-4 py-3 bg-background rounded-lg border-2 border-transparent focus:outline-none focus:border-brown-700 transition" />
                            </div>

                            {/* Campo Telefone */}
                            <div>
                                <label htmlFor="phone" className="block text-sm font-semibold text-zinc-700 mb-2">Seu Telefone</label>
                                <input type="tel" id="phone" name="phone" placeholder="(11) 99999-9999" className="block w-full px-4 py-3 bg-background rounded-lg border-2 border-transparent focus:outline-none focus:border-brown-700 transition" />
                            </div>

                            {/* Dropdown de Serviços */}
                            <div>
                                <label htmlFor="service" className="block text-sm font-semibold text-zinc-700 mb-2">Serviço</label>
                                <select id="service" name="service" className="block w-full px-4 py-3 bg-background rounded-lg border-2 border-transparent focus:outline-none focus:border-brown-700 transition appearance-none">
                            ...
                            <div>
                                ...
                                <select id="barber" name="barber" className="block w-full px-4 py-3 bg-brand-white rounded-lg border-2 border-transparent focus:outline-none focus:border-brown-700 transition appearance-none">
                            ...
                            <div className="flex-grow flex items-end justify-center pt-6">
                                <button type="submit" className="w-full bg-accent text-white font-bold text-lg px-8 py-4 rounded-full hover:bg-accent-dark transition-colors shadow-lg">
