export default function Footer() {
    ...
    const SocialIcons = () => (
        <div className="flex gap-4">
            <a href="#" className="text-cream/70 hover:text-white transition-colors">
            ...
            <div className="container mx-auto px-4 sm:px-6 md:px-8 py-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="md:col-span-2">
                        ...
                        <p className="mt-4 max-w-xs text-cream/80">
                    ...
                    <div>
                        ...
                        <nav className="mt-4 flex flex-col gap-2">
                            {navLinks.map(link => (
                                <a key={link.label} href={link.href} className="text-cream/80 hover:text-white transition-colors">
                                    {link.label}
                                </a>
                            ))}
                        </nav>
                ...
                <div className="mt-16 border-t border-brown-700 pt-8 text-center text-sm text-cream/60">
